...
$stu_student = "SELECT * FROM students";
$stu_result = mysqli_query($conn, $stu_student);
?>
                                ...
                                <table class="data-table table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($stu_result) > 0) {
                                            while ($row = mysqli_fetch_array($stu_result)) {
                                                $id = $row['id'];
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myLargeModalLabel">Create Student</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" action="./php/studet_create.php">
                ...
                <div class="modal fade" id="Edit-modal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="editStudentForm" method="POST" action="./php/student_edit.php">
