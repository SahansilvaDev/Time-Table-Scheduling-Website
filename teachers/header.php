            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto" id="navbar-li">
                    <li class="nav-item">
                        <p style="cursor:pointer; font-size:35px;" class="main_hedding">
                            <img src="./sltc.png" alt="" width="70px" height="35px">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profileDropdown" height="100px">
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profileDropdown">
                            ...
                            <div class="dropdown-divider"  href="./t_chat.php">Chat</div>
