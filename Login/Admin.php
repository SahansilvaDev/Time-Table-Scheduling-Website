        ...
        <div class="row w-100 no-gutters">
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-center bg-white p-4 p-lg-5">
                <div class="text-center">
                    ...
                    <h4 class="text-secondary mb-4">Admin's Login</h4>
                </div>
                <?php if (isset($error)): ?>
...
<?php endif; ?>
                ...
                <form class="w-100" method="POST" action="php/login.php">
                    <div class="form-group">
                        <input type="email" class="form-control rounded-pill shiny-border" name="email" id="email" placeholder="example@sltc.ac.lk" required>
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control rounded-pill shiny-border" name="password" id="password" placeholder="**********" required>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <a href="./Teacher.php" class="btn btn-primary rounded-pill">Go to Lecturer's Login</a>
                            </div>
                            <div class="col-auto">
                                <a href="./Student.php" class="btn btn-primary rounded-pill">Go to Student's Login</a>
                            </div>
