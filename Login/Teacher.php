...
<head>
    ...
    <title>Xeduler Lecturer's Login</title>

    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="./assests/css/style.css"> <!-- Corrected path for assets -->
        ...
        <div class="row w-100 no-gutters">
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-center bg-white p-4 p-lg-5">
                <div class="text-center">
                    ...
                    <h4 class="text-secondary mb-4">Lecturer's Login</h4>
                </div>
                
                <!-- Login Form -->
                <form class="w-100" action="./php/teacher.php" method="post"> <!-- Corrected action path -->
                    <!-- Email Field -->
                    <div class="form-group">
                        <input type="email" name="email" class="form-control rounded-pill shiny-border" id="email" placeholder="Email: example@sltc.ac.lk">
                    </div>

                    <!-- Password Field -->
                    <div class="form-group">
                        <input type="password" name="password" class="form-control rounded-pill shiny-border" id="password" placeholder="**********">
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <div class="row justify-content-center mx-2">
                            <div class="col-auto">
                                <a href="./Student.php" class="btn btn-primary rounded-pill">Student's Login</a>
                            </div>
                            <div class="col-auto">
